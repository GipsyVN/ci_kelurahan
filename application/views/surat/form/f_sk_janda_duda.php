...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <!-- Buat Konten Disini -->
    <h1 class="h3 mb-4 text-gray-800"><?php echo "Surat Keterangan Janda/Duda" ?></h1>
    <?= $this->session->flashdata('message') ?>

    <div class="row">
        <div class="col">
            <form action="<?= base_url('surat/ket_janda_duda'); ?>" method="post">
                <div class="form-group row">
                    ...
                    <label for="no_akta" class="col-sm-2 col-form-label">Nomor Akta Kematian</label>
                    <div class="col-sm-9 mb-3">
                        <input type="text" class="form-control" id="no_akta" name="no_akta"
                            value="<?= set_value('no_akta') ?>"></input>
                        <?= form_error('no_akta', '<small class="text-danger pl-3">', '</small>') ?>
                    </div>
                </div>
